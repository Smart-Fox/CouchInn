...
<body>
	<?php
		...
		if(isset($_SESSION['usuario'])){
			...
			<br>
			<h2 style="color:#96ac3c; text-align:center"><span>Cambios guardados</span></h2>
			<h3 style="text-align:center"><span>Su anuncio ahora contiene la siguiente información.</h3></span>
			<br>
			<div class='row'>
