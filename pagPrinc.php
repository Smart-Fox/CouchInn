		...
		if(isset($_SESSION['usuario'])){
			...
			<form action="pagPrinc.php" method="POST" enctype="multipart/form-data">
				<div class='row barra-filtro'>
					...
					<div class='col-xs-2 col-md-2 elem-filtro2'>
			...
			<a href='publicar.php'><button type=button class='btn5'>Publicar un anuncio</button></a>
			<?php
			if($anun){
				for ($i=1; $i<=$anun->num_rows; $i+=2){
					echo "	<div class='row'>
