<?php
	...
	class registerService{
		...
		public function registrarUsuario(){
			...
			$consulta = ("INSERT INTO usuario(ID, Nombre, Apellido, Telefono, Username, Email, Contraseña) VALUES ('NULL', '$this->nombre', '$this->apellido','$this->telefono', '$this->nomUser', '$this->email', '$this->password');");
